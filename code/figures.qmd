...
**Organism focus**: 
`r paste0(unique(dat_descr$val[dat_descr$var == "organism"]), collapse = "/n")`

<!-- figure_print base (just for making following plots consistent) -->
  
```{r figure_printure-base, include = FALSE}
...
auto_plot_descr <- function(dat1, column0, other_cutoff = 0, title0 = "") {
  ...
  dat_names$val1 <- factor(x = dat_names$val1,
                           levels = unique(dat_names$val1), 
                             labels = unique(dat_names$val1), 
                             ordered = TRUE)
  ...
  dat00 <- dat0 %>%
    ...
    # ADD CUMULATIVE FREQUENCIES HERE?
...
```{r research-field-line}
#| label: research-field-line
...
```{r research-field-bar}
#| label: research-field-bar
...
```{r research-field-area}
#| label: research-field-area
...
```{r cond-research-field-line}
#| label: cond-research-field-line
...
```{r cond-research-field-bar}
#| label: cond-research-field-bar
#| fig-cap: "Bar plot of frequency and year, by research field. [Condensed Categories] "

knitr::include_graphics(path = here::here("output", paste0("bar-", column0,".png")))
```

```{r cond-research-field-area}
#| label: cond-research-field-area
...
```{r cumulativefreq-research-field, eval = FALSE}
#| label: research-field-cumline
...
```{r research-field-table}
#| label: research-field-table
...
```{r}
#| label: gear_type-line
#| tbl-cap: "Line Plot of frequency and year, by gear type. "

column0 = "gear_type"
figure_print <- auto_plot_descr(dat1 = dat_descr, 
                          column0 = column0, 
                          other_cutoff = 0, 
                          title0 = "Plot of frequencyency and year, by gear type")
...
```{r}
#| label: gear_type-bar
#| tbl-cap: "Bar Plot of frequency and year, by gear type. "
...
```{r}
#| label: gear_type-area
#| tbl-cap: "Area Plot of frequency and year, by gear type. "
...
```{r}
#| label: cond-gear_type-line
#| tbl-cap: "Line Plot of frequency and year, by gear type. [Condensed Categories]"

column0 = "condensed_gear"
figure_print <- auto_plot_descr(dat1 = dat_descr, 
                          column0 = column0, 
                          other_cutoff = 0, 
                          title0 = "Plot of frequencyency and year, by gear type [Condensed Categories]")

knitr::include_graphics(path = here::here("output", paste0("line-", column0,".png")))
```

```{r}
#| label: cond-gear_type-bar
#| tbl-cap: "Bar Plot of frequency and year, by gear type. [Condensed Categories]"
...
```{r}
#| label: cond-gear_type-area
#| tbl-cap: "Area Plot of frequency and year, by gear type. [Condensed Categories]"
...
```{r, eval=FALSE}
#| label: cond-gear_type-cumfreq
#| tbl-cap: "Line Plot of cumulative frequency and year, by gear type. [Condensed Categories]"
...
```{r}
#| label: location-line
#| tbl-cap: "Line Plot of frequency and year, by location. "

column0 = "location"
figure_print <- auto_plot_descr(dat1 = dat_descr, 
                          column0 = column0, 
                          other_cutoff = 0, 
                          title0 = "Plot of frequencyency and year, by location")
...
```{r}
#| label: location-bar
#| tbl-cap: "Bar Plot of frequency and year, by location. "
...
```{r}
#| label: survey-line
#| tbl-cap: "Plot of frequencyuency and year, by survey "

column0 = "survey"
figure_print <- auto_plot_descr(dat1 = dat_descr, 
                          column0 = column0, 
                          other_cutoff = 0, 
                          title0 = "Plot of frequencyency and year, by survey")
...
```{r}
#| label: survey-bar
#| tbl-cap: "Bar Plot of frequencyuency and year, by survey "
...
```{r}
#| label: organism-line
#| tbl-cap: "Plot of frequencyuency and year, by organism "

# column0 = "organism"
# figure_print <- auto_plot_descr(dat1 = dat_descr, 
#                           column0 = column0, 
#                           other_cutoff = 0, 
#                           title0 = "Plot of frequencyency and year, by organism")
# 
# knitr::include_graphics(path = here::here("output", paste0("line-", column0,".png")))
...
```{r}
#| label: organism-line
#| tbl-cap: "Line Plot of frequencyuency and year, by organism "
...
```{r}
#| label: organism-bar
#| tbl-cap: "Bar Plot of frequencyuency and year, by organism "
...
```{r}
#| label: organism-area
#| tbl-cap: "Area Plot of frequencyuency and year, by organism "
...
```{r}
#| label: cond-organism-line
#| tbl-cap: "Line Plot of frequencyuency and year, by organism [Condensed Categories] "

column0 = "condensed_organism"
figure_print <- auto_plot(dat1 = dat, 
                          column0 = column0, 
                          other_cutoff = 20, 
                          title0 = "Plot of frequencyency and year, by organism [Condensed Categories]")
knitr::include_graphics(path = here::here("output", paste0("line-", column0,".png")))
```

```{r}
#| label: cond-organism-bar
#| tbl-cap: "Bar Plot of frequency and year, by organism [Condensed Categories]"

knitr::include_graphics(path = here::here("output", paste0("bar-", column0,".png")))
```

```{r}
#| label: cond-organism-area
#| tbl-cap: "Area Plot of frequencyuency and year, by organism [Condensed Categories]"

knitr::include_graphics(path = here::here("output", paste0("area-", column0,".png")))
```

Plot of frequency and year, by journal

```{r}
#| label: source_title-line
#| tbl-cap: "Plot of frequencyuency and year, by organism "
...
figure_print <- auto_plot(dat1 = dat, 
                          column0 = column0, 
                          other_cutoff = 20, 
                          title0 = "Plot of frequencyency and year, by journal")
knitr::include_graphics(path = here::here("output", paste0("line-", column0,".png")))
```

Plot of frequency and year, by affiliation

```{r}
#| label: affiliation-line
#| tbl-cap: "Plot of frequencyuency and year, by affiliation "
...
```{r}
#| label: keyword-line
#| tbl-cap: "Plot of frequencyuency and year, by keyword "
