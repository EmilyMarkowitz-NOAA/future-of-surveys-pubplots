...
c("university of new brunswick", "university of manitoba","acadia university", "carleton university", "concordia university  canada", "bangor university", "dalhousie university", "queens university  canada", "nova southeastern university" , "laval university", "mcgill university", "memorial university newfoundland" ,"vancouver island university", "university of toronto", "university of british columbia" , "universite de montreal", "university of quebec", "university of guelph", "universite du quebec a rimouski", "simon fraser university", "victoria university", "university toronto", "university of victoria"))), 
  ...
  "Ecuadorian Universities" = c(find_words(where = dat_temp$val, word = c("escuela superior politecnica del litoral"))),
...
c("universidade dos acores", "universidade de coimbra", "universidade do porto", "universidade de aveiro", "university of tras os montes & alto douro", "universidade do algarve", "universidade de lisboa" ))), 
  ...
  "Tunisian Universities" = c(find_words(where = dat_temp$val, word = c("universite de sfax", "universite de tunis el manar", "faculte des sciences de tunis"))),
  ...
  "Argentinian Research Societies and Institutes" = c(find_words(where = dat_temp$val, word = c("national fisheries research & development institute", "instituto antartico argentino", "instituto de astronomia y fisica del espacio"))), 
  "Argentinian Government" = c(find_words(where = dat_temp$val, word = c("consejo nacional de investigaciones cientificas y tecnicas", "centro nacional patagonico", "cenpat", "national fisheries research & development institute (inidep)"))),
  ...
  "Chilean Research Societies and Institutes" = 
    c(find_words(where = dat_temp$val, word = 
                   c("instituto de fomento pesquero"))), 
  "Chinese Research Societies and Institutes" = 
    c(find_words(where = dat_temp$val, word = 
                   c("chengdu institute", "kunming institute of zoology", "national engineering research center for oceanic fisheries", "fishery machinery & instrument research institute", "institute of geochemistry, cas", "institute of hydrobiology, cas", "institute of oceanology, cas"))),
  # "Chinese Government" = 
  #   c(find_words(where = dat_temp$val, word = 
  #                  c("china", "beijing", "yangtze river", "chinese", "pearl river", "guangzhou", "yellow sea", "laoshan laboratory", "guangdong", "ministry of agriculture & rural affairs"))),
  ...
  "French Research Societies and Institutes" = 
    c(find_words(where = dat_temp$val, word = 
  ...
  "Icelandic Research Societies and Institutes" = c(find_words(where = dat_temp$val, word = c("marine & freshwater research institute"))), 
  "Indonesian Government" = c(find_words(where = dat_temp$val, word = c("ministry of marine affairs and fisheries"))), 
  "Indian Research Societies and Institutes" = c(find_words(where = dat_temp$val, word = c("tata institute of fundamental research", "centre for marine living resources & ecology", "cmlre", "central marine fisheries research institute", "national centre for biological sciences", "central coastal agricultural research institute"))), 
  "Indian Government" = c(find_words(where = dat_temp$val, word = c("India"))), 
  "Irish Research Societies and Institutes" = c(find_words(where = dat_temp$val, word = c("marine institute ireland"))),
  "Irish Government" = c(find_words(where = dat_temp$val, word = c("agri food & biosciences institute"))),
  "Italian Research Societies and Institutes" = c(find_words(where = dat_temp$val, word = c(
  ...
  "Japanese Research Societies and Institutes" = c(find_words(where = dat_temp$val, word = c("research organization of information & systems", "national institute of advanced industrial science & technology"))), 
  ...
  "Mexican Research Societies and Institutes" = c(find_words(where = dat_temp$val, word = c("centro de investigaciones biologicas del noroeste", "cibnor", "cicese  centro de investigacion cientifica y de educacion superior de ensenada", "centro de investigacion en alimentacion y desarrollo"))),
  "Mongolian Research Societies and Institutes" = c(find_words(where = dat_temp$val, word = c("mongolian academy of sciences"))), 
  "New Zealand Government" = c(find_words(where = dat_temp$val, word = c("new zealand"))),
  # "Netherlands Museums and Education" = c(find_words(where = dat_temp$val, word = c("netherlands", "holland"))),
  "Netherlands Government" = c(find_words(where = dat_temp$val, word = c("naturalis biodiversity center"))),  
  "Norwegian Government" = c(find_words(where = dat_temp$val, word = c(#"Norwegian", "norway",
    "bjerknes centre for climate research"))),
  "Peruvian Research Societies and Institutes" = c(find_words(where = dat_temp$val, word = c("instituto del mar del peru"))),
  "Portuguese Research Societies and Institutes" = c(find_words(where = dat_temp$val, word = c("instituto de telecomunicacoes", "instituto superior psicologia aplicada"))),
  "Polish Research Societies and Institutes" = c(find_words(where = dat_temp$val, word = c("national marine fisheries research institute"))),
  ...
  "Russian Research Societies and Institutes" = c(find_words(where = dat_temp$val, word = c("research lnstitute of fisheries & oceanography", "tinro", "papanin institute for biology of inland waters"))), 
  ...
  "South Korea Research Societies and Institutes" = c(find_words(where = dat_temp$val, word = c("national institute of fisheries science"))),
  # "South Korea Government" = c(find_words(where = dat_temp$val, word = c("korea"))),  
  "Spanish Government" = c(find_words(where = dat_temp$val, word = c("csic", "centro mediterraneo de investigaciones marinas y ambientales", "cmima", "spanish"))), 
  # "Switzerland Government" = c(find_words(where = dat_temp$val, word = c("zurich", "Switzerland"))),
  "Swedish Government" = c(find_words(where = dat_temp$val, word = c("beijer institute of ecological economics", "swedish meteorological & hydrological institute"))),
  "Swedish Museums and Education" = c(find_words(where = dat_temp$val, word = c("swedish museum of natural history"))),
  ...
  "UK Research Societies and Institutes" = c(find_words(where = dat_temp$val, word = c("natural environment research council", "institute of biological, environmental, rural & sciences",  "ibers", "biotechnology and biological sciences research council", "centre for environment fisheries & aquaculture science", "zoological society of london", "uk research & innovation", "ukri"))),
