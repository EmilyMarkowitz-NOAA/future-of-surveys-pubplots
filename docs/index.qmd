...
searches <- data.frame(type = "Bottom trawls", 
                       search = '"bottom trawl" OR "beam trawl" OR "otter trawls"') 

searches <- dplyr::bind_rows(searches, 
                             data.frame(type = "Acoustic trawls", 
                                        search = '"Mid water trawl" OR "Mid-water trawl" OR "Midwater trawl" OR "pelagic trawl" "OR "Acoustic/traw"'))

searches <- dplyr::bind_rows(searches, 
                             data.frame(type = "Dredge", 
                                        search = '"dredge" OR "benthos'))
...
searches <- dplyr::bind_rows(searches, 
                             data.frame(type = "Stationary gear", 
                                        search = '"stationary gear" AND "pot" AND "trap" AND "HOOK AND LINE" AND "HOOK & LINE" OR "LONGLINE"'))
...
searches <- dplyr::bind_rows(searches, 
                             data.frame(type = "Aerial surveys", 
                                        search = '"drone" OR "drones" OR "lidar" OR "plane" or "aerial"'))

searches$search <- paste0('"Fishery independent survey" OR "Fisheries independent survey" OR "Fishery-independent survey" OR "Fisheries-independent survey" OR "fish survey" OR "ecosystem survey" OR "Fishery independent data" AND ', searches$search)

searches <- dplyr::bind_rows(searches, 
                             data.frame(type = "All FIS", 
                                        search = '"Fishery independent survey" OR "Fisheries independent survey" OR "Fishery-independent survey" OR "Fisheries-independent survey" OR "fish survey" OR "ecosystem survey" OR "Fishery independent data"'))
...
for (searches0 in 1:length(searches$search)){
  numpubs <- c()
  print(searches0)
  for (yr in yrs) {
    print(yr)
...
plot_figure <- function(numpubs0, log_a = FALSE, allfis_a = FALSE, yr5bin_b = FALSE) {
...
if (log_a) {
  pp1 <- pp1 + scale_y_continuous(trans='log2', name = "")
} else {
  pp1 <- pp1 +  ggplot2::ylab("")
}
...
p1 <- plot_figure(numpubs0, log_a = FALSE, allfis_a = FALSE, yr5bin_b = FALSE) 
p2 <- plot_figure(numpubs0 %>% 
  dplyr::filter(year >= 1960), 
  log_a = FALSE, allfis_a = FALSE, yr5bin_b = FALSE) 
p3 <- plot_figure(numpubs0 %>% 
  dplyr::filter(year >= 1960), 
  log_a = TRUE, allfis_a = TRUE, yr5bin_b = TRUE) 
p4 <- plot_figure(numpubs0 %>% 
  dplyr::filter(year >= 1960), 
  log_a = TRUE, allfis_a = FALSE, yr5bin_b = TRUE) 
