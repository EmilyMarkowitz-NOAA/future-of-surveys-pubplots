...
aaa <- data_condense(dat_descr, variable = "keywords", list0, append = "cond1")
...
list0 <- list(
  "Mobile gear" = c("Longline", "BTS", "ATS", "Ring nets", "Hook and Line", "net", "Survey phrases", "Trawl phrases"), 
...
list0 <- list00 <- list(
  ...
  "Canadia Universities" = c(find_words(where = dat_temp$val, word = 
...
# Create condensed affiliation categories (part 2) -------------------------------------
...
aaa <- data_condense(dat_descr, variable = "affiliations_cond1", list0, list_as_is = TRUE, append = "_cond2")

dat_descr <- aaa$dat_descr

# Create condensed affiliation categories (part 3) -------------------------------------
...
aaa <- data_condense(dat_descr, variable = "affiliations_cond1", list0, list_as_is = TRUE, append = "_cond3")
