...
ggsave(filename = here::here("docs/index_files/figure-html/", paste0("{{var0}}-wordcloud.png")),
       plot = figure_print, width = 6, height = 6)

# knitr::include_graphics(path = here::here("docs/index_files/figure-html/", paste0("{{var0}}-wordcloud.png")))
```
